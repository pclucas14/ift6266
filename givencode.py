...
def resize_mscoco():
    ...
    data_path="C:\Users\pcluc\Desktop\School\UdeM\Deep Learning 5xx\project\data\train2014"
    save_dir = "output"
...
def show_examples(batch_idx, batch_size,
                  ### PATH need to be fixed
                  mscoco="C:\Users\pcluc\Desktop\School\UdeM\Deep Learning 5xx\project\data", split="train2014", caption_path="worddict.pkl"):
    '''
